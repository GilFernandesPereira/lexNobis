...
// exports.sendNotification = functions.database.ref('/ProjetoSolidao/{userID}/{pushId}').onWrite((change,context) => {
...
exports.sendNotificationsAnimador = functions.database.ref('/ProjetoSolidao/{userID}/{nif}/{pushId}').onWrite((change,context) => {
